const BeansData = [
    ...
    },
    {
      id: 'B2',
      name: 'Arabica Beans',
      description: `Arabica beans are by far the most popular type of coffee beans, making up about 60% of the worldâ€™s coffee. These tasty beans originated many centuries ago in the highlands of Ethiopia, and may even be the first coffee beans ever consumed! The name Arabica likely comes from the beansâ€™ popularity in 7th-century Arabia (present-day Yemen).`,
      roasted: 'Medium Roasted',
    ...
    },
    {
      id: 'B3',
      name: 'Liberica Beans',
      description: `Native to central and western Africa â€“ specifically Liberia, hence its name â€“ Coffea liberica is prized for its piquant floral aroma and bold, smoky flavor profile. Growing from a much larger plant than Arabica or Robusta, most Liberica cherries tend to be irregular in shape and closer to Robusta in size and general appearance. Itâ€™s also tolerant of hot, humid climates and does well at low altitude. `,
      roasted: 'Medium Roasted',
    ...
    },
    {
      id: 'B4',
      name: 'Excelsa Beans',
      description: `Excelsa beans grow almost entirely in Southeast Asia, and theyâ€™re shaped somewhat like Liberica beans â€” elongated ovals. These beans grow on large 20 to 30-foot coffee plants at medium altitudes. In terms of flavor, Excelsa beans are pretty unique. They combine light roast traits like tart notes and fruity flavors with flavors that are more reminiscent of dark roasts.`,
      roasted: 'Medium Roasted',
